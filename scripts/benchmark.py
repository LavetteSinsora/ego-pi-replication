...
# Baseline (pretrained π0.5, no fine-tuning):
  third_party/openpi/.venv/bin/python scripts/benchmark.py \
...
Run from the openpi fork root (third_party/openpi — norm stats resolve
relative to cwd) with PYTHONPATH pointing at its third_party/libero
