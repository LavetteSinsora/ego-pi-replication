...
Run: .venv/bin/python -m pytest data_extraction/tests/test_corner_cases.py -q
"""
...
from ..common.episode import (build_control_grid, make_control_grid_ticks,
                              spike_mask, Episode, _resample_side)
from ..common.rot6d import mat_to_6d, rot6d_to_mat, se3_to_vec9, vec9_to_se3
from ..config import PipelineConfig
from ..loader.boundary import BoundaryAwareIndices
from ..loader.relative_actions import RelativeChunkActions
from ..config import load_config
from ..s004_filter_split import (_bridge_short_runs, _residual_bad,
...
def test_rate_limit_and_invalid_fill():
    from ..hand.retarget import HandRetargeter
    ...
    from ..hand.constants import CMD_RATE_LIMIT, MOTOR_ORDER
...
def test_blocked_mask_requires_sustained_static_error():
    from ..hand.screen import BLOCK_FRAMES, ERR_HARD, blocked_mask
    T = BLOCK_FRAMES + 4
...
def test_s005_rejects_unimplemented_state_content():
    from .. import s005_write_lerobot
