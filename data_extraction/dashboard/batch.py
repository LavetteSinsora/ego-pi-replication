...
<title>data_extraction batch report</title><style>{_CSS}</style></head><body>
<div class="wrap">
<h1>data_extraction batch report — {len(rows)} episode(s), source: {source}</h1>
...
<div class="small">Generated by data_extraction.dashboard --batch.
