...
from ..hand.constants import ACTUATOR_NAME, MJCF_PATH, MOTOR_ORDER
from ..hand.screen import COUPLE
...
def build_g1_hands_model(mount=None):
    ...
    with warnings.catch_warnings():
        # option conflicts (timestep etc.) are irrelevant: this composite
        # model is kinematic-only, the parent's options win by design
