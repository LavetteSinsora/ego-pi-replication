...
def _wrist_to_palm_mean(cfg, ep_paths, side):
    ...
    from ..hand.fk_tables import palm_frame_from_points
    from ..hand.retarget import _quat_to_rot
...
def _per_episode_Bs(cfg, ep_paths, backend):
    from ..sim.placement import calibrate_alignment, first_valid_tick
